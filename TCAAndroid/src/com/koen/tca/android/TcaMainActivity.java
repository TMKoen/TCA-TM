...
public class TcaMainActivity extends Activity {
	...
	private AndroidStateMachine androidState;			// the state of the Android device: Idle, Expose, Ready or Test
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/**
		 * Initialize the statemachine. The Android goes to the Idle state by default.
		 */
